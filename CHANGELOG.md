...
All notable changes to the Role Call Sync module for Foundry VTT.
...
- File everything under a single top-level **Role Call** folder, with one child
  folder per campaign, in the order Role Call has them rather than alphabetical.
...
**This module does not import maps.** A Role Call scene is a narrative prep
